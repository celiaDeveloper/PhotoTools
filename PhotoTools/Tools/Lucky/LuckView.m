...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.iv = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.w, self.h)];
...
- (void)setImageArray:(NSMutableArray *)imageArray {
    ...
    CGFloat upj = 5;
    CGFloat imageW = 10;
    CGFloat btnw = (self.w - imageW * 2 - j * 2 - upj * 2)/3;
    CGFloat ivj = 5;
    ...
    for (int i = 0; i < imageArray.count + 1; i++) {
        ...
        btn.tag = i > 4? i -1: i;
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(ivj, ivj, btn.w - ivj * 2, btn.w - ivj * 2)];
        [btn addSubview:imageView];
        [imageView sd_setImageWithURL:[_imageArray objectAtIndex:i > 4? i -1: i] placeholderImage:[UIImage imageNamed:@"photoBack"]];
